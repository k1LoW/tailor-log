...
require (
	buf.build/gen/go/tailor-inc/tailor/connectrpc/go v1.20.0-20260721053028-29acf470b283.1
	buf.build/gen/go/tailor-inc/tailor/protocolbuffers/go v1.36.11-20260721053028-29acf470b283.1
