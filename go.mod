...
require (
	buf.build/gen/go/tailor-inc/tailor/connectrpc/go v1.19.1-20260122030510-96f58a5b2070.2
	buf.build/gen/go/tailor-inc/tailor/protocolbuffers/go v1.36.11-20260122030510-96f58a5b2070.1
